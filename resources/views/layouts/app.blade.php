...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <meta name="description" content="Tailor Management System">
        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="index.html" class="logo">
                        <span>
                            <img src="{{ asset('images/img1.png') }}" alt=""  class="thumb-md img-rounded bg-white"> <span>TMS</span>
                        </span>
                        <i>
                           <img src="{{ asset('images/img1.png') }}" alt="" class="thumb-md img-rounded bg-white">
                        </i>
                    </a>
                </div>
            ...
            <div class="content-page">
                ...
                <footer class="footer text-right">
                    {{date('Y')}} © <span class="text-danger">TMS v1.1.</span>
                    <span class="pull-right">
                        <i class="fa fa-heart text- text-danger"></i> by <span class="text-danger">Deepak Kumar</span>
                    </span>
                </footer>
